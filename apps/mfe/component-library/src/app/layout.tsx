  ...
  return (
    ...
    >
      <head>
        ...
        <ThemeScript brandThemeUrl={`${process.env.NEXT_PUBLIC_BASE_URL || (process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'http://localhost:3002')}/component-library/themes/stackone-green.json`} />
      </head>
