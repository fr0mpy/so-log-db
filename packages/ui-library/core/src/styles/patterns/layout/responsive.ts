...
export const Responsive = {
  ...
  // Container patterns
  Container: {
    // Fixed viewport height for scrollable layouts (uses svh for mobile browser chrome)
    fullHeight: 'h-screen h-[100svh]',

    // Minimum height for content that can grow beyond viewport
    minFullHeight: 'min-h-screen min-h-[100svh]',
