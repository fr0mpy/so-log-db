...
import { ResponsiveSpacing, ResponsiveTypography, Responsive, SpacingTokens } from './styles'
...
export const GalleryStyles = {
  ...
  sidebar: {
    ...
    /** Sidebar scroll area */
    scrollArea: 'h-full overflow-y-auto p-4',
  ...
  /** Scrollable content wrapper - combines scroll behavior and padding */
  scrollArea: [
